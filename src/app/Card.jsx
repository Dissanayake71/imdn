  ...
  return (
    ...
    sm:border-slate-400 sm:m-2 transition-shadow duration-200" group>
       <Link href={`/movie/${result.id}`}>
        ...
        duration-200" style={{maxWidth:"100%", height:"auto"}} placeholder="blur" blurDataURL="/spinner.svg"
        ></Image>
        <div className="p-2 ">
            <p className="line-clamp-2 text-md">{result.overview}</p>
            <h2 className="truncate text-lg font-bold">{result.title || title.name}</h2>
